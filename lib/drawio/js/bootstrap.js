...
(function()
{
    ...
    if (mxIsElectron)
    {
        mxmeta(null, 'default-src \'self\'; script-src \'self\' \'sha256-6g514VrT/cZFZltSaKxIVNFF46+MFaTSDTPB8WfYK+c=\' ' +
            ...
            'connect-src \'self\'; ' +
            'img-src \'self\' data: blob:; media-src \'self\' data: blob:; font-src \'self\' data:; frame-src \'self\'; style-src \'self\' \'unsafe-inline\' ' +
            'base-uri \'none\';child-src \'self\';object-src \'none\';', 'Content-Security-Policy');
    }
})();
